use ods;
drop table if exists odstmp_bpms_biz_customer_rel_common;
CREATE TABLE ods.odstmp_bpms_biz_customer_rel_common (
  ...
  customer_type STRING COMMENT '客户类型 标准受薪，优良职业，自雇',
  ...
  id_card_type_name STRING COMMENT '证件类型名'
) STORED AS parquet;

insert overwrite table odstmp_bpms_biz_customer_rel_common
select a.id,
a.apply_no,
a.customer_no,
a.house_portion,
...
a.rev,
a.delete_flag,
a.is_actual_borrower_name,
a.has_common_borrower,
a.borrower_relation,
a.other_relation,
...
b.id_card_type,
b.id_card_validity,
case when b.id_card_no = "440304199003052215" then a.apply_no else b.id_card_no end id_card_no,
b.id_card_address,
b.marital_status,
...
b.address,
b.income_type,
regexp_replace(regexp_replace(regexp_replace(regexp_replace(regexp_replace(regexp_replace(lower(income_type),'com','标准受薪'),'god','优良职业'),'slf','自雇'),'^自雇$','自雇'),'^受薪$','标准受薪'),'^oth$','其他') income_type_name,
b.monthly_income,
b.employer,
b.former_name,
b.former_id_card,
...
g.NAME_ id_card_type_name
from ods_bpms_biz_customer_rel a
left join ods_bpms_biz_customer b on a.customer_no=b.cust_no
left join (select DISTINCT KEY_,NAME_new_ NAME_ from ods_bpms_sys_dic_common where TYPE_ID_='10000010830911' or TYPE_ID_='10000057530172' or TYPE_ID_='10000034210010' or TYPE_ID_='10000025010002' or  TYPE_ID_='10000001220223' or TYPE_ID_='10000034210010' or TYPE_ID_='1000000122021' or TYPE_ID_='10000033770002' )d on d.KEY_=lower(a.`relation`)
left join (select DISTINCT KEY_,NAME_new_ NAME_ from ods_bpms_sys_dic_common where TYPE_ID_='10000010830911' or TYPE_ID_='10000057530172' or TYPE_ID_='10000034210010' or TYPE_ID_='10000025010002' or  TYPE_ID_='10000001220223' or TYPE_ID_='10000034210010' or TYPE_ID_='1000000122021' or TYPE_ID_='10000033770002' )e on e.KEY_=lower(a.`role`)
left join (select DISTINCT KEY_,NAME_new_ NAME_ from ods_bpms_sys_dic_common where type_id_='10000000520012' or type_id_='10000056709003' )g on g.KEY_=lower(b.`id_card_type`);

drop table if exists ods_bpms_biz_customer_rel_common;
ALTER TABLE odstmp_bpms_biz_customer_rel_common RENAME TO ods_bpms_biz_customer_rel_common;