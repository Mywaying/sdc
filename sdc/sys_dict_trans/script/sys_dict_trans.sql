use ods;
create table odstmp_bpms_sys_dic_common as
...
from ods_bpms_sys_dic;

drop table if exists ods_bpms_sys_dic_common;
ALTER TABLE odstmp_bpms_sys_dic_common RENAME TO ods_bpms_sys_dic_common;